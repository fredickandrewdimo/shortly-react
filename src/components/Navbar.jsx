  ...
  return (
    <nav className="navbar w-11/12 md:w-9/12 mx-auto py-5 md:flex md:items-center md:justify-between">
      <div className="flex items-center justify-between w-full md:w-fit">
        ...
        <Link
          to="/shortly-react/"
          className="font-bold text-2xl mr-8 hover:text-lightGreen"
        >
          Shortly
        </Link>
        {/* Hamburger Menu */}
      ...
      >
        <div className="text-gray-400 font-bold text-lg flex flex-col md:flex-row mb-5 md:mb-0">
          <Link to="/shortly-react/" className="md:mr-3 hover:text-gray-700">
            Features
          </Link>
          <Link to="/shortly-react/" className="md:mr-3 hover:text-gray-700">
            Pricing
          </Link>
          <Link to="/shortly-react/" className="hover:text-gray-700">
            Resources
          </Link>
        </div>
